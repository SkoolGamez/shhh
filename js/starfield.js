...
var Star = /** @class */ (function () {
  function Star(container) {
    ...
    this.color = "rgb("
      .concat(randRange(110, 200), ",")
      .concat(randRange(110, 240), ",")
      .concat(randRange(230, 255), ")");
  }
...
var getPointerInput = function (callback, element, delay) {
  ...
  var handlePointer = function (event) {
    ...
    animFrame = window.requestAnimationFrame(function () {
      ...
      if (event.touches) {
        (_a = [event.touches[0].clientX, event.touches[0].clientY]),
          (x = _a[0]),
          (y = _a[1]);
      } else {
...
var StarField = /** @class */ (function () {
  function StarField(howManyStars, canvas, depth, UIFadeDelay) {
    ...
    window.addEventListener("beforeunload", function () {
      return _this.rePopulateStarField();
    });
    // not in use yet
  ...
  StarField.prototype.drawMouseControl = function () {
    ...
    var pointIsInEllipse = isInEllipse(
      this.mouseX,
      this.mouseY,
      ellipseX,
      ellipseY,
